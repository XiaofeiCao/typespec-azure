...
- **ExtendedLocation**: Support for deploying resources to Azure Edge Zones or Custom Locations.
...
Support for deploying resources to Azure Edge Zones or Custom Locations. To add extended location support, add the `ExtendedLocationProperty` envelope property to the resource definition:
