...
- **ManagedBy**: Indicating that this resource is managed by another resource.
- **ExtendedLocation**: Supporting deployment to extended locations such as Azure Edge Zones.
- **AvailabilityZones**: Specifying the availability zones for the resource.
...
Support for deploying a resource to extended locations such as Azure Edge Zones. To enable extended location support, add the `ExtendedLocationProperty` envelope property to the resource definition:
...
Support for specifying the availability zones for a resource. To include availability zone support, add the `AvailabilityZonesProperty` envelope property to the resource definition:
