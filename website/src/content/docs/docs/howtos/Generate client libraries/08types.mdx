...
Delimited array encodings are also preserved in generated Go models for string arrays and string-backed enum arrays. The public model stays array-typed, and the generated serialization code joins and splits the encoded wire representation.
